...
class ServiceSessionState(object):
    ...
    def setAppDataDict(self, dictval, errFlag=False, format='json'):
        try:
    ...
    #
    def setServiceError(self, msg, errFlag=True, format='json'):
        self.__D['errorflag'] = errFlag
        self.__D['errormessage'] = msg
        self.__D['responseformat'] = format
    #

    def setServiceWarning(self, msg, warnFlag=True, format='json'):
