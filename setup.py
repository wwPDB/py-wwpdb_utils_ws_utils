...
packages = []
thisPackage = 'wwpdb.utils.ws_utils'

with open('wwpdb/utils/ws_utils/__init__.py', 'r') as fd:
...
setup(
    name=thisPackage,
    version=version,
    description='wwPDB remote services support library',
    ...
    #
    install_requires=['pytz', 'PyJWT', 'oslo.concurrency', 'wwpdb.api.config', 'webob'],
